...
class HParameters:
    ...
    def __init__(self):
        ...
        self.epochs_max = 2000
        self.train_batch_size = 1

        self.output_dir = 'ex-10'

        self.root = ''
        self.datasets=["datasets/dataset_summe_inception_v3.h5","datasets/dataset_tvsum_inception_v3.h5"]
        self.splits = ["splits/summe_aug_splits.json"]#"splits/tvsum_splits.json",#"splits/summe_aug_splits.json""splits/summe_aug_splits.json",
        return
